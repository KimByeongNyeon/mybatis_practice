...
<label>입사일 : </label><input type="text" name="hiredate" readonly="readonly" value='<fmt:formatDate value= "${ed.ename}" pattern ="yyyy-MM-dd" />'/><br/>
</c:catch>
<c:if test="${ not empty param.empno and empty ed }">
<span style="color: #FF0000">사원정보가 존재하지 않습니다.</span>
</c:if>
